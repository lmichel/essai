...
public class VodmlBlockParserValuesTest {
	VotableModel votableModel;
	VodmlBlockParser treeBuilder;

	@Before
	public void setUp() throws Exception {
		URL url = VodmlBlockParserValuesTest.class.getResource("/test/xml/annot_multiband.xml");
		String sampleName =url.getFile();;
		this.votableModel = new VotableModel(sampleName);
		treeBuilder = new VodmlBlockParser(Parser.class.getResourceAsStream("/test/xml/annot_multiband.xml"));
		treeBuilder.parse();
